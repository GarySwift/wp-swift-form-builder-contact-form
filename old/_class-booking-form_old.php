...
if ( is_plugin_active( 'wp-swift-form-builder/form-builder.php' ) )  {
    ...
    if(class_exists('WP_Swift_Form_Builder_Plugin')) {
         ...
         *
         */
        class WP_Swift_Form_Builder_Booking_Form_Plugin extends WP_Swift_Form_Builder_Plugin {
            ...
            public function plugin_activated() {
                ...
                $page_definitions = array(
                    'booking-page' => array(
                        'title' => __( 'Booking Us', 'wp-swift-form-builder-booking-form' ),
                        'content' => '<p>Please use the form below to submit any questions you may have.</p>[wp-swift-booking-form]'
                    ),
                );
                $post_ids = array();
                /*
                ...
                set_transient( 'booking-form-plugin-activate-notice', $post_ids, 5 );
            } 
            ...
            public function plugin_activate_fail_admin_notice() {
                ...
                $message = __( '<strong>WP Swift: Form Builder Booking Form Add-On</strong> requires the plugin <strong>WP Swift: Form Builder</strong> to be installed. Please download this plugin from <a href="https://github.com/GarySwift/wp-swift-form-builder" target="_blank"><b>here</b></a>.', 'wp-swift-form-builder-booking-form' );
            ...
            public function enqueue_javascript () {
                wp_enqueue_script( $handle='wp-swift-form-builder-booking-form', $src=plugins_url( '/assets/javascript/wp-swift-form-builder-booking-form.js', __FILE__ ), $deps=null, $ver=null, $in_footer=true );
            }
            /**
             ...
             */
            public function render_booking_form( $attributes, $content = null ) {
                $Form_Builder = null;
                if ( class_exists('WP_Swift_Form_Builder_Plugin')) {
                    ...
                    // return __( '<h4>Please install plugin WP Swift: Form Builder</h4>', 'wp-swift-form-builder-booking-form' );
                    add_action( 'admin_init', array($this, 'plugin_deactivate') );
                    add_action( 'admin_notices', array($this, 'plugin_activate_fail_admin_notice') );
                    return null;
                }
                // Render the booking form using an external template
            ...
            private function get_template_html( $template_name, $attributes = null, $Form_Builder = null) {
                ...
                ob_start();
                do_action( 'custom_booking_before_' . $template_name );//To do
                ...
                do_action( 'custom_booking_after_' . $template_name );
        ...
        return $html;
            ...
            private function get_form_data() {
                $options = get_option( 'wp_swift_form_builder_booking_form_settings' );
                ...
                // echo "<pre>"; var_dump(isset($options['wp_swift_form_builder_checkbox_css'])); echo "</pre>";
                if (isset($options['wp_swift_form_builder_booking_form_checkbox_first_last_name'])) {
                    $form_first_and_last_name = true;
                }
                if (isset($options['wp_swift_form_builder_booking_form_checkbox_phone'])) {
                    $form_phone = true;
                }
            ...
            public function wp_swift_form_builder_booking_form_add_admin_menu(  ) { 

                // add_submenu_page( 'tools.php',
                //  'WP Swift Form Builder Booking Form',
                //  'WP Swift Form Builder Booking Form',
                //  'manage_options',
                //  'wp_swift_form_builder_booking_form',
                //  'wp_swift_form_builder_booking_form_options_page' );

                if ( empty ( $GLOBALS['admin_page_hooks']['wp-swift-brightlight-main-menu'] ) ) {
                    $options_page = add_options_page( 
                        'Form Builder Booking Page Configuration',
                        'Form Builder: Booking Page',
                        'manage_options',
                        'wp-swift-form-builder-booking-form-settings-menu',
                        array($this, 'wp_swift_form_builder_booking_form_options_page') 
                    );  
                }
                else {
        ...
        /*
        */
            public function wp_swift_form_builder_booking_form_settings_init(  ) { 

                register_setting( 'wp_swift_form_builder_booking_form_plugin_page', 'wp_swift_form_builder_booking_form_settings' );

                add_settings_section(
                    'wp_swift_form_builder_booking_form_plugin_page_section', 
                    __( 'Set your preferences for the Booking Form here', 'wp-swift-form-builder-booking-form' ), 
                    array($this, 'wp_swift_form_builder_booking_form_settings_section_callback'), 
                    'wp_swift_form_builder_booking_form_plugin_page'
                );

                add_settings_field( 
                    'wp_swift_form_builder_booking_form_checkbox_first_last_name', 
                    __( 'Use first and last names', 'wp-swift-form-builder-booking-form' ), 
                    array($this, 'wp_swift_form_builder_booking_form_checkbox_first_last_name_render'), 
                    'wp_swift_form_builder_booking_form_plugin_page', 
                    'wp_swift_form_builder_booking_form_plugin_page_section' 
                );

                add_settings_field( 
                    'wp_swift_form_builder_booking_form_checkbox_phone', 
                    __( 'Use telephone', 'wp-swift-form-builder-booking-form' ), 
                    array($this, 'wp_swift_form_builder_booking_form_checkbox_phone_render'), 
                    'wp_swift_form_builder_booking_form_plugin_page', 
                    'wp_swift_form_builder_booking_form_plugin_page_section' 
                );
            }
            ...
            public function wp_swift_form_builder_booking_form_checkbox_first_last_name_render(  ) { 

                $options = get_option( 'wp_swift_form_builder_booking_form_settings' );
                ?>
                <input type='checkbox' name='wp_swift_form_builder_booking_form_settings[wp_swift_form_builder_booking_form_checkbox_first_last_name]' <?php checked( $options['wp_swift_form_builder_booking_form_checkbox_first_last_name'], 1 ); ?> value='1'>
                <?php

            }


            public function wp_swift_form_builder_booking_form_checkbox_phone_render(  ) { 

                $options = get_option( 'wp_swift_form_builder_booking_form_settings' );
                ?>
                <input type='checkbox' name='wp_swift_form_builder_booking_form_settings[wp_swift_form_builder_booking_form_checkbox_phone]' <?php checked( $options['wp_swift_form_builder_booking_form_checkbox_phone'], 1 ); ?> value='1'>
                <?php

            }

            public function wp_swift_form_builder_booking_form_settings_section_callback(  ) { 

                echo __( 'This section description', 'wp-swift-form-builder-booking-form' );

            }


            public function wp_swift_form_builder_booking_form_options_page(  ) { 
                if ( get_option( 'wp_swift_form_builder_booking_form_settings' )) {
                    $wp_swift_form_builder_booking_form_settings = get_option( 'wp_swift_form_builder_booking_form_settings' );
                    echo "<pre>"; var_dump($wp_swift_form_builder_booking_form_settings); echo "</pre>";
                }
                ?>
                <div id="form-builder-wrap" class="wrap">
                    <h2>WP Swift Form Builder Booking Form</h2>
                    <form action='options.php' method='post'>

                        <?php
                            settings_fields( 'wp_swift_form_builder_booking_form_plugin_page' );
                            do_settings_sections( 'wp_swift_form_builder_booking_form_plugin_page' );
                            submit_button();
                        ?>
